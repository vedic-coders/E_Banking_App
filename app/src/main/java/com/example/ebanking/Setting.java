...
public class Setting extends AppCompatActivity {
    ...
    static String userId, profilePicStr;
    Users user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(), com.example.ebanking.ViewProfilePhoto.class);
...
//                logout.setMessage("Change or Delete Profile Photo");
                ...
                if(profilePicStr != "https://firebasestorage.googleapis.com/v0/b/e-banking-21b68.appspot.com/o/userDefaultImage.png?alt=media&token=0edd4309-dc04-4a0a-8e32-be5284e6e8c2")
                {
                    logout.setNegativeButton("Delete Photo", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            profilePicStr = user.profilePic = "https://firebasestorage.googleapis.com/v0/b/e-banking-21b68.appspot.com/o/userDefaultImage.png?alt=media&token=0edd4309-dc04-4a0a-8e32-be5284e6e8c2";
                            Picasso.get().load(user.profilePic).into(profilePic);
                            imageUri = null;
                            saveData();
                        }
